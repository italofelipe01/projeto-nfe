...
FINAL_CREDENTIALS: Dict[str, CredentialData] = {str(k): v for k, v in CREDENTIALS.items()}
...
BROWSER_CONFIG: Dict[str, Any] = PLAYWRIGHT_CONFIG.get(RPA_MODE, PLAYWRIGHT_CONFIG['development'])
